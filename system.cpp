...
//boot from the 1mb boundary without switching to real mode first
//this probably can't be used for anything except booting from a c++ os binary
extern "C" void bootFromHighMem();
...
void printStartup()
{
	printString("Scott's Basic Protected Mode Bootloader", 0x0F);
}
