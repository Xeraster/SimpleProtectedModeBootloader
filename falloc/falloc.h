...
const unsigned int MEMORY_LOC = 0x40000;//0x30004;    //put the start location right above the stack so the system doesn't crash every time you try to load a file larger than ~60kb off the disk
